...
function DialogContent({
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-full p-1.5 opacity-70 transition-opacity hover:opacity-100 hover:bg-accent focus:outline-none cursor-pointer">
