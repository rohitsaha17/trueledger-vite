import type { StackingProject } from "@/components/ui/stacking-card";

/* ------------------------------------------------------------------ */
/*  Shared methodology steps — rendered as scroll-stacking panels on    */
/*  the About page and as a minimal card grid on the landing page.      */
/* ------------------------------------------------------------------ */

export const methodologySteps: StackingProject[] = [
  {
