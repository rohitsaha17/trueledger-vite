...
/**
 * Gates a whitepaper PDF behind a short lead-capture form. On submit the PDF
 * opens in a new tab. NOTE: submitted details are not yet sent anywhere —
 * wire `handleSubmit` to a form endpoint / CRM to actually capture leads.
 */
