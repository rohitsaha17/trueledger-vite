  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-brand-tint via-background to-background">
        ...
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-heading text-[20rem] font-bold text-brand/[0.04] select-none pointer-events-none leading-none"
      ...
      <section className="py-20 md:py-28 bg-brand-dark relative overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-1/3 right-[15%] w-64 h-64 bg-coral/10 rounded-full blur-3xl"
