...
/* ------------------------------------------------------------------ */
/*  Static case-study data (merged with API results at runtime)       */
/* ------------------------------------------------------------------ */
...
/** Map an API CaseStudy (which lacks `service`) to our DisplayStudy shape. */
...
export default function CaseStudiesPage() {
  ...
  /* Merge API rows (converted) with static data, deduping by slug */
  const allStudies: DisplayStudy[] = (() => {
    const cmsConverted = cmsStudies.map(toDisplayStudy);
